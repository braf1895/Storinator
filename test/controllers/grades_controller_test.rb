...
class GradesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create grade" do
    assert_difference('Grade.count') do
      post grades_url, params: { grade: { course_number: @grade.course_number, grade: @grade.grade } }
    end
  ...
  test "should update grade" do
    patch grade_url(@grade), params: { grade: { course_number: @grade.course_number, grade: @grade.grade } }
